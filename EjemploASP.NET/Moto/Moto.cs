...
namespace dominio
{
    ...
    public class MotoNegocio
    {
        public List<Moto> listar()
        {
            ...
            moto1.Color = "Rojo";
            moto1.FechaFabricacion = new DateTime(2023, 08, 12).ToString("dd/MM/yyyy");
            moto1.Usado = false;
            ...
            moto2.Color = "Negro";
            moto2.FechaFabricacion = new DateTime(2018, 12, 09).ToString("dd/MM/yyyy");
            moto2.Usado = true;
            ...
            moto3.Color = "Gris";
            moto3.FechaFabricacion = new DateTime(2026, 07, 07).ToString("dd/MM/yyyy");
            moto3.Usado = false;
